            ...
            <div className="hero">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    {/* <div className="lg-px-20">
                        <ReactPlayer className="rounded-lg shadow-2xl" control url="https://youtu.be/FGnlxE2Fawg" />
                    </div> */}
                    <div className="lg:px-16">
                        <h1 className="text-3xl font-bold">WE AIM TO PROVIDE YOU THE BEST QUALITY PRODUCTS</h1>
                        <p className="py-6">
