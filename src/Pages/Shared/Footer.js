...
import footer from '../../imsge/footer.jpg'

const Footer = () => {
    return (
        <div>
            <footer style={{ background: `url(${footer})`, backgroundSize: "cover" }} className="footer p-10 bg-base-300 text-white">
                <div>
                    <span className="footer-title">Services</span>
                    <Link to="/" className="link link-hover">MOTORCYCLE PARTS</Link>
                    <Link to="/" className="link link-hover">COMPLETE BICYLE</Link>
                    <Link to="/" className="link link-hover">FASTNERS & OTHER ITEMS</Link>
                    <Link to="/" className="link link-hover">MOTORCYCLE PARTS</Link>
                </div>
                <div>
